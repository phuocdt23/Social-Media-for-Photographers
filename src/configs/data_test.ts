export const data_test = {
  ...
  albumTestData: {
    successCreateAlbum1: {
      name: 'album1',
      description: 'this belong to user002',
    },
    changedNameAlbum1: {
      name: 'changedAlbum1',
      description: 'this belong to user002(changed description)',
    },
    albumUser002: {
      username: 'albumUser002',
      email: 'albumUser002@gmail.com',
      name: 'albumUser002',
      password: '123123',
    },
    albumUser003: {
      username: 'albumUser003',
      email: 'albumUser003@gmail.com',
      name: 'albumUser003',
      password: '123123',
    },
  },
